...
vinf_bound = [3,1.5,1.5]/VU;                % Velocity bounds for all GA v_inf values
...
% phase
dt_min = [1,1,1]*86400/TU;          % Minimum time of flight in TU
dt_max = [1.5,1.5,1.5]*86400/TU;          % Maximum time of flight in TU
