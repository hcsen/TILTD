% Celestial system
N_perts = 3;                        % Number of perturbing bodies
centralBodyName = 'Saturn';            % Central body name in words
pertNames = strsplit('Titan,Enceladus,Dione', ',');       % Perturbing bodies in words
...
NLP_feas_tol = 1e-6;                 % NLP solver feasibility tolerance
NLP_tol = 1e-2;                      % NLP solver optimality tolerance
...
m_perts = [1.345e23, 1.080e20, 1.095e21];      % Titan, Enceladus, Dione
...
r_perts = [2574.7, 252.1, 561.4];          % Titan, Enceladus, Dione
...
h_mins = [25];                     % Minimum height above flyby body in km
